...
//SPI显示屏接口
//LCD_RST
#define SPILCD_RST_SET  GPIO_SetBits(GPIOA, GPIO_Pin_3)//PB0 
#define SPILCD_RST_RESET GPIO_ResetBits(GPIOA, GPIO_Pin_3)//PB0  
//LCD_RS//dc  
#define SPILCD_RS_SET  GPIO_SetBits(GPIOA, GPIO_Pin_2)//PC4 
#define SPILCD_RS_RESET  GPIO_ResetBits(GPIOA, GPIO_Pin_2)//PC4  
//LCD_CS  
